 ...
 * Generated at: 2017-07-20 18:29:12 UTC
...
public final class chart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("work.model.dto.Bias");
    _jspx_imports_classes.add("work.model.dto.Opinion");
    _jspx_imports_classes.add("work.model.service.TeamService");
    _jspx_imports_classes.add("work.model.dto.Vote");
...
for(int i=0;i<biasList.size();i++){
      ...
      out.write("\r\n");
      out.write("          ['");
      out.print(biasList.get(i).getBiasName());
      out.write("',    ");
      out.print(bcount);
      out.write("],\r\n");
      out.write("          ");
      ...
      out.write("        function selectHandler(e) {\r\n");
      out.write("        \t\r\n");
      out.write("        \tdocument.getElementById(\"body\").innerHTML +='<div id=\"abc\"><div id=\"popupContact\"><form action=\"TeamController?action=opinionManagement&sub=makeOpinion\" id=\"voteform\" method=\"post\" name=\"voteform\"><img id=\"close\" width=\"25px\" height=\"25px\" src=\"images/x.png\" onclick=\"div_hide()\"><h2 id=\"headH2\">의견을 작성해주세요!</h2><hr>\\\r\n");
      out.write("        \t\t\t<input style=\"width:200px\" id=\"none\" name=\"name\" type=\"text\" value=\"");
      out.print(session.getAttribute("nickname"));
      out.write("\" readonly>\\\r\n");
      out.write("        \t\t\t<input style=\"width:200px\" id=\"teamMOpinionBiasName\" name=\"teamMOpinionBiasName\" type=\"text\" placeholder=\"Choice category!\">\\\r\n");
      out.write("        \t\t\t<textarea style=\"width:200px\" id=\"teamMOpinionContent\" name=\"teamMOpinionContent\" placeholder=\"Please tell me your voice!\"></textarea><input type=\"submit\" id=\"submit\"></form></div></div>';\r\n");
...
boolean isLogin = (session != null && session.getAttribute("memberId") != null ? true : false);
      ...
      out.write("\t\t$(\"#header-frame\").load(\"header-login-frame.jsp\");\r\n");
      out.write("\t});\r\n");
} else {
      out.write("\r\n");
      out.write("\t$(document).ready(function() {\r\n");
